...
$lnge = "SELECT * FROM language WHERE language_id='$language_id'";
$lnge_query = mysqli_query($con, $lnge) or die (mysql_error());
$rslnge = mysqli_fetch_assoc($lnge_query);
...
<body>
  ...
  <?php do { ?>
    <?php 
      ...
      $language_id            = $rslnge['language_id'];
      $language_name          = $rslnge['language_name'];
      $language_icon          = $rslnge['language_icon'];
      $language_description   = $rslnge['language_description'];
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-8 col-sm-12">
            <h1 class="g-font-size-24--md g-color--primary"><?php echo $language_name; ?></h1>
          </div>
...
<?php } while ($rslnge = mysqli_fetch_assoc($lnge_query)) ?>
</html>
